...
with(this){return _c('ul',[_c('li',[_v("stores the data, i.e., all "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Contact")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Todo")]),_v(", and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Event")]),_v(" objects (which are contained in separate "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniqueItemList")]),_v(" objects).")]),_v(" "),_c('li',[_v("stores the currently 'selected' objects (e.g., results of a search query) as a separate "),_c('em',[_v("filtered")]),_v(" list which is exposed to outsiders as an unmodifiable "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ObservableList")]),_v(" that can be 'observed' e.g. the UI can be bound to this list so that the UI automatically updates when the data in the list change.")]),_v(" "),_c('li',[_v("stores a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UserPref")]),_v(" object that represents the user’s preferences. This is exposed to the outside as a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ReadOnlyUserPref")]),_v(" objects.")]),_v(" "),_c('li',[_v("does not depend on any of the other three components (as the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" represents data entities of the domain, they should make sense on their own without depending on other components)")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("The diagram below shows how the APIs of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" component are exposed.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Storing "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Contact")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Todo")]),_v(", and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Event")]),_v(" share many similarities, so we extract common methods into abstract classes. Yes, we know that we are geniuses at naming things.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The diagram below shows how a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Contact")]),_v(" is managed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The diagram below shows how a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Todo")]),_v(" is managed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(". An "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Event")]),_v(" is managed in a similar way.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The diagram below shows different relationship between different "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Item")]),_v("s managed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case 1: Create a contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to create a new contact and provides contact details.")])]),_v(" "),_c('li',[_c('p',[_v("TC creates a new contact and adds it to the contact list.")])]),_v(" "),_c('li',[_c('p',[_v("TC displays a confirmation message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view all contacts.")])]),_v(" "),_c('li',[_c('p',[_v("TC displays a list of all contacts.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to filter all contacts using some specific criteria.")])]),_v(" "),_c('li',[_c('p',[_v("TC displays the matching contacts along with the number of results.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Contact")]),_v(": A stored record of a student or tutor, containing relevant details such as name, ID, and class.")]),_v(" "),_c('li',[_c('strong',[_v("Tag")]),_v(": A specific keyword which can be associated with an arbitrary value, for a specific contact.\n"),_c('ul',[_c('li',[_c('strong',[_v("Class")]),_v(": A group of students assigned to a particular tutor.")]),_v(" "),_c('li',[_c('strong',[_v("Course")]),_v(": A subject or academic course that multiple classes and students may belong to.")])])]),_v(" "),_c('li',[_c('strong',[_v("Event")]),_v(": A scheduled session such as tutorial class, remedial, or consultation that tutors can create, modify, and assign students to.")]),_v(" "),_c('li',[_c('strong',[_v("Todo")]),_v(": A task or action item that can be associated with a student or another tutor, such as grading assignments, scheduling follow-ups, or preparing lesson materials.")]),_v(" "),_c('li',[_c('strong',[_v("Head Tutor")]),_v(": A tutor responsible for overseeing other tutors.")]),_v(" "),_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS.")])])}
},function anonymous(
) {
