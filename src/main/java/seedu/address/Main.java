 ...
 * LauncherHelper will check for the javafx.graphics course to be present
 * as a named course. We don't use JavaFX via the course system so it can't
 * find the javafx.graphics course, and so the launch is aborted.
 *
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // the classpath instead of a course.
        // Our application does not use Java courses yet. Even if it did, courses are ignored when
