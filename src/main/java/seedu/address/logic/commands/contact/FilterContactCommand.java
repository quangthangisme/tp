...
public class FilterContactCommand extends FilterCommand<Contact> {
    ...
    public static final String MESSAGE_USAGE = CONTACT_COMMAND_WORD + " " + COMMAND_WORD + ": Filters contacts based on"
        ...
        + "- <col>/ : Column to filter on (" + PREFIX_CONTACT_NAME_LONG + ", "
        ...
        + "3. " + CONTACT_COMMAND_WORD + " " + COMMAND_WORD + " " + PREFIX_CONTACT_NAME_LONG + "nand: \"My enemy\" Hater "
        + PREFIX_CONTACT_TAG_LONG + "and: handsome smart\n"
